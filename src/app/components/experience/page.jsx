...
const ExperienceSection = () => {
  return (
    <div className="flex flex-col gap-14 container" id="career">
      {/* ============== HEADING ============== */}
      ...
      <div className="flex flex-col gap-20">
        {ExperienceJson && ExperienceJson?.length
          ? ExperienceJson?.map((experience, index) => {
              return (
                <div
                  className="flex flex-col gap-6 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-6"
                  key={index}
                >
                  {/* ============== Company Detail & Experience ============== */}
                  <div className="flex flex-col justify-between gap-1 sm:gap-6 sm:flex-row sm:items-center md:gap-8 lg:gap-10">
                    {/* ------------ Company name & Logo ------------ */}
                    ...
                    {/* --------- Start & End Date --------- */}
                    <div className="text-sm sm:text-base text-[#8491A0] text-left sm:text-right">
